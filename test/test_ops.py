...
class RoIPoolTester(RoIOpTester, unittest.TestCase):
    ...
    def get_script_fn(self, rois, pool_size):
        @torch.jit.script
        def script_fn(inputs, rois, pool_size):
            # type: (Tensor, Tensor, int) -> Tensor
            return ops.roi_pool(inputs, rois, pool_size, 1.0)[0]
...
class PSRoIPoolTester(RoIOpTester, unittest.TestCase):
    ...
    def get_script_fn(self, rois, pool_size):
        ...
        def script_fn(inputs, rois, pool_size):
            # type: (Tensor, Tensor, int) -> Tensor
            return ops.ps_roi_pool(inputs, rois, pool_size, 1.0)[0]
        return lambda x: script_fn(x, rois, pool_size)
...
class RoIAlignTester(RoIOpTester, unittest.TestCase):
    ...
    def get_script_fn(self, rois, pool_size):
        ...
        def script_fn(inputs, rois, pool_size):
            # type: (Tensor, Tensor, int) -> Tensor
            return ops.roi_align(inputs, rois, pool_size, 1.0)[0]
        return lambda x: script_fn(x, rois, pool_size)
...
class PSRoIAlignTester(RoIOpTester, unittest.TestCase):
    ...
    def get_script_fn(self, rois, pool_size):
        ...
        def script_fn(inputs, rois, pool_size):
            # type: (Tensor, Tensor, int) -> Tensor
            return ops.ps_roi_align(inputs, rois, pool_size, 1.0)[0]
        return lambda x: script_fn(x, rois, pool_size)
