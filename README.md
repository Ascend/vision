...
-  需完成Torchvision安装。
   ...
   -  方法2：pip安装
      ...
      ```
      注：方法2 pip安装可能出现torch和torchvision不匹配的问题，如有此问题，建议使用方法1 源码编译安装。
...
注：docker中运行使用dvpp功能，需要映射`/dev/dvpp_cmdlist`设备文件，文件权限相关说明请参考[对Docker进行安全加固](https://www.hiascend.com/document/detail/zh/mindcluster/72rc1/clustersched/dlug/mxdlug_com_022.html)。
